...
twenty_news = fetch_20newsgroups_vectorized()
X_train, X_test, y_train, y_test = train_test_split(twenty_news.data,
                                                    twenty_news.target,
                                                    test_size=0.3,
                                                    random_state=42)
...
dump(knn_model, "D:/1. PXU/16. Hoc may va khoa hoc du lieu/3.HocMay01/mo-hinh/mhplknn-twenty_news-3.joblib")
