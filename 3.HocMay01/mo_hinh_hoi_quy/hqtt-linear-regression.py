...
dump(model, "D:/1. PXU/16. Hoc may va khoa hoc du lieu/3.HocMay01/mo-hinh/mhhqtt.joblib")

print("Tai mô hình từ file")
model2 = load("D:/1. PXU/16. Hoc may va khoa hoc du lieu/3.HocMay01/mo-hinh/mhhqtt.joblib")
print("Success")